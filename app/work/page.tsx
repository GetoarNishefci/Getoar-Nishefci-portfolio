...
const projects = [
    {
        ...
        description:"A full stack e-commerce web application built with React, Node.js, Express, and MongoDB. It features user authentication, product management, and a shopping cart.",
    ...
    },
     {
        ...
        description:"A full stack e-commerce admin dashboard built with React, Node.js, Express, and MongoDB. It features user authentication, product management, and order tracking.",
        stack:[{name:"Next.js"},{name:"React"},{name:"Tailwind"},{name:"Prisma"},{name:"PostgreSQL"}],
    ...
    },
       {
        ...
        description:"A full stack medical clinic management system built with React, Node.js, Express, and MongoDB. It features user authentication, patient management, and appointment scheduling.",
